...
// Fungsi helper untuk mendapatkan preview channel sebagai contextInfo
...
🎨 *STICKER MENU*
┣ ${prefix}brat <teks> — Stiker brat
┣ ${prefix}brathd <teks> — Stiker brat HD
┗ ${prefix}s — Ubah foto/video jadi stiker

📡 *SALURAN MENU*
┣ ${prefix}cekidch <link> — Cek info ID Channel WA
┗ ${prefix}createch <nama>|<deskripsi> — Buat Channel [Owner]

📥 *DOWNLOADER MENU*
┣ ${prefix}ig <url> — Download konten Instagram
┗ ${prefix}tt <url/judul> — Download TikTok tanpa watermark

👥 *GROUP MENU*
┣ ${prefix}hidetag <teks> — Tag semua member (Admin)
┣ ${prefix}promote @tag — Jadikan admin
┣ ${prefix}demote @tag — Copot admin
┗ ${prefix}kick @tag — Keluarkan member

🎮 *GAME MENU*
┣ ${prefix}suitpvp @tag — Tantang main Gunting Batu Kertas
┗ ${prefix}slot <angka> — Main mesin slot

🛠️ *MAKER MENU*
┣ ${prefix}iqc <teks> — Buat chat bubble iPhone
┗ ${prefix}tohitam (reply foto) — 30+ filter AI converter

📱 *SOSIAL MEDIA*
┣ ${prefix}owner-tt — TikTok Owner
┣ ${prefix}owner-ig — Instagram Owner
┗ ${prefix}owner-channel — Saluran WhatsApp Resmi

━━━━━━━━━━━━━━━━━━━━━━━
_Powered by Baileys MD • 2026_`;
            ...
            case 'owner-tt':
                await sock.sendMessage(from, { 
                    text: "Link TikTok Owner:\n👉 https://www.tiktok.com/@zyyzall",
                    contextInfo: getChannelPreview("TikTok Owner", "@zyyzall — ZYY-CYBER")
                }, { quoted: m });
                break;

            case 'owner-ig':
                await sock.sendMessage(from, { 
                    text: "Link Instagram Owner:\n👉 https://www.instagram.com/abcdeezall",
                    contextInfo: getChannelPreview("Instagram Owner", "@abcdeezall — ZYY-CYBER")
                }, { quoted: m });
                break;

            case 'owner-channel':
                await sock.sendMessage(from, { 
                    text: "Link Saluran WhatsApp Resmi:\n👉 " + CHANNEL_URL,
                    contextInfo: getChannelPreview("Saluran Resmi RIJAL-MD", "Join sekarang untuk update terbaru!")
                }, { quoted: m });
                break;
